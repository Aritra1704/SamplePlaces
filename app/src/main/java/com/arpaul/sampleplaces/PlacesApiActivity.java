...
import com.arpaul.sampleplaces.adapter.PlaceAutocompleteAdapter;
...
/**
 * Created by Aritra on 16-03-2017.
 */

public class PlacesApiActivity extends AppCompatActivity implements OnMapReadyCallback,
//        AdapterView.OnItemClickListener,
        GoogleApiClient.OnConnectionFailedListener {

    private AutoCompleteTextView autocomplete_places;
    private TextView place_attribution, place_detail;
    ...
    private ResultCallback<PlaceBuffer> mUpdatePlaceDetailsCallback
        ...
        public void onResult(PlaceBuffer places) {
            ...
            place_detail.setText(formatPlaceDetails(getResources(), place.getName(),
            ...
            if (thirdPartyAttribution == null) {
                place_attribution.setVisibility(View.GONE);
            } else {
                place_attribution.setVisibility(View.VISIBLE);
                place_attribution.setText(Html.fromHtml(thirdPartyAttribution.toString()));
            }
...
//    }
    ...
    void initialiseControls() {
        ...
        place_attribution = (TextView) findViewById(R.id.place_attribution);
